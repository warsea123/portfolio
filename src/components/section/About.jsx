...
const SkillCard = ({ skill }) => {
  ...
  useEffect(() => {
    // Delay to allow the component to mount before animating the progress bar
  ...
  return (
    <div className="animate-fadeInUp text-center p-6 rounded-lg shadow-lg bg-white dark:bg-gray-900 transition-all transform hover:scale-105 hover:shadow-xl">
      ...
      <div className="mt-2">
        <div className="relative pt-1">
          ...
          <div className="w-full bg-gray-300 dark:bg-gray-700 rounded-full overflow-hidden">
            <div
              style={{ width }}
              className={`h-2 ${skill.color} transition-all duration-1000 ease-in-out`}
            />
          </div>
        </div>
      </div>
...
const About = () => {
  return (
    <section className="py-20 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="animate-fadeInUp text-4xl font-semibold text-center mb-10">
          Technologies
        </h2>
        <div className="animate-fadeInUp grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {skills.map((skill) => (
